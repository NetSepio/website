    ...
    <div className="connectivity-container">
      <div className="connectivity-box">
        ...
        <p className="connectivity-text">
          NetSepio delivers private, secure, and censorship-free internet with an AI coordination
          layer for secure data and inference, shaping an agentic future. Powered by a
