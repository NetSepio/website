...
const Socials = () => {
  return (
    <div className='bg-white h-[312px] my-[3%] w-full rounded-b-[40px] flex items-center justify-center gap-[10%]'>
      <div className='w-[120px] h-[120px] flex justify-center items-center  bg-black rounded-[20px]'>
      ...
      <div className='w-[120px] h-[120px] flex justify-center items-center  bg-transparent rounded-[20px]'>
